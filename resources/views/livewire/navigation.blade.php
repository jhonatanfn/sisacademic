        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <div class="hidden sm:block sm:ml-6">
            <div class="flex space-x-4">
              ...
              hover:text-white px-3 py-2 rounded-md text-sm font-medium">Comunicados</a>
              ...
              {{-- @foreach ($categorias as $categoria)
                <a href="{{route('comunicados.categoria',$categoria)}}" 
                class="text-gray-300 hover:bg-gray-700 
   ...
   {{-- menu mobil --}}
    <div class="sm:hidden" x-show="open" x-on:click.away="open=false">
      ...
      <a href="{{route('notas.index')}}" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium">Notas</a>
       ...
       <a href="{{route('comunicados.categoria',$categoria)}}" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">{{$categoria->nombre}}</a>
       @endforeach  --}}
